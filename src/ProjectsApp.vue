    ...
    <div>
      ...
      >
        ...
        <div
          ...
          :key="project.name"
          class="md:md-6 -mx-0.5 mb-4 rounded-lg border border-gray-200 px-1.5 py-1 md:-ml-4 md:py-3 md:pl-4 md:pr-2 dark:border-gray-700"
        >
...
const githubIconUrl = new URL('icon/github-mark.svg', import.meta.url).href
const githubIconDarkUrl = new URL('icon/github-mark-white.svg', import.meta.url)
  .href
